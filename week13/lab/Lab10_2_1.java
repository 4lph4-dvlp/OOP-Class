...
public class Lab10_2_1 extends Thread {
  String name;
  Spaghetti bowl;
  Fork left, right;
  int scoops;

  public Lab10_2_1(String name, Spaghetti bowl, Fork left, Fork right) {
    this.name = name;
    this.bowl = bowl;
    this.left = left;
    this.right = right;
  ...
  public static void main(String args[]) {
    ...
    Lab10_2_1 guest[] = new Lab10_2_1[NUM_OF_GUESTS];
    ...
    for (int i = 0; i < NUM_OF_GUESTS; ++i) {
      ...
      guest[i] = new Lab10_2_1(names[i], bowl[i], fork[left], fork[right]);
      guest[i].start();
    }
    ...
    for (int i = 0; i < NUM_OF_GUESTS; ++i) {
      try {
        ...
        System.out.println("Lab10_2_1.main(): 사용자에 의해 중단됨");
      }
    }
